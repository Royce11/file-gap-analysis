...
def initCsv():
    ...
    fieldnames = ['vendor','datasource','country','Year-Month','Date']
        ...
        if key == "Contents":
            ...
            if personDemosFilePattern:
                ...
                for tupleElement in personDemosFilePattern:
                    ...
                    tempList.insert(3,'01')
                    tupleElement = tuple(tempList)
                    personDemosFileLists.append(tupleElement)
            ...
            if machineDemosFilePattern:
                ...
                for tupleElement in machineDemosFilePattern:
                    ...
                    tempList.insert(3,'01')
                    tupleElement = tuple(tempList)
                    machineDemosFileLists.append(tupleElement)
