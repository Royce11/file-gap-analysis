...
fileObj = open('/home/osboxes/shared-windows10/comscore_intl_clean_input_2018.txt','r')
...
jsonObj = open('/home/osboxes/shared-windows10/comscore_intl_clean_cadence.json','r')
...
for args in pathsList:
    ...
    metadata = {'vendor' : vendor, 'datasource' : datasource, 'country' : country,'type' : 'intl'}
